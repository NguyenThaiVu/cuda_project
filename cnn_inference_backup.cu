...
int main() 
{
    ...
    // Load input image
    const char* inputImagePath = "image/digit_8.jpg";  
    ...
    float *d_input, *d_conv_output, *d_final_output;
    ...
    saveArrayToFile(d_conv_output, OUTPUT_CONV_CHANNELS * OUTPUT_CONV_WIDTH * OUTPUT_CONV_HEIGHT, "z_output_conv.txt");
    ...
    saveArrayToFile(d_final_output, OUTPUT_SIZE, "z_output_fc.txt");
